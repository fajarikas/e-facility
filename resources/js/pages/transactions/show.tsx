...
export default function UserTransactionShow({
    transaction,
    contactUrl,
}: Props) {
    ...
    const status =
        transaction.status ||
        (transaction.is_booked === 'Yes' ? 'booked' : 'pending_payment');
                    ...
                    <div className="space-y-1">
                        <div className="flex items-center gap-3">
                            <h1 className="text-3xl font-black tracking-tight text-gray-900">
                                Transaksi{' '}
                                <span className="text-[#1f9cd7]">
                                    #{transaction.id}
                                </span>
                            </h1>
                            <span
                                className={cn(
                                    'inline-flex items-center rounded-full px-3 py-1 text-[10px] font-black tracking-widest uppercase shadow-sm',
                                    status === 'booked'
                        ...
                        {status === 'pending_payment' &&
                            (remainingMs === null || remainingMs > 0) && (
                                <Button
                                    ...
                                    onClick={() =>
                                        router.post(
                                            `/my-transactions/${transaction.id}/cancel`,
                                            {},
                                            { preserveScroll: true },
                                        )
                                    }
                            ...
                            <div className="flex items-center gap-5">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold tracking-widest uppercase opacity-80">
                                        Hubungi admin via WhatsApp sebelum waktu
                                        habis
                                    </p>
                                </div>
                            </div>
                            ...
                            <Card className="overflow-hidden rounded-[2.5rem] border-none bg-white shadow-lg ring-1 ring-gray-100">
                                <div className="flex flex-col sm:flex-row">
                                    <div className="aspect-[4/3] w-full sm:w-48">
                                        <img
                                            src={
                                                transaction.room?.images?.[0]
                                                    ? `/storage/${transaction.room.images[0]}`
                                                    : '/images/landingpage/contoh.webp'
                                            }
                                    ...
                                    <div className="flex flex-1 flex-col justify-center p-6">
                                        ...
                                        <p className="text-xs font-bold tracking-widest text-[#1f9cd7] uppercase">
                                            {transaction.room?.building?.name}
                                        </p>
                                        <div className="mt-4 flex items-center gap-4 text-xs font-bold tracking-widest text-muted-foreground uppercase">
                        ...
                        <Card className="overflow-hidden rounded-[2.5rem] border-none bg-white shadow-2xl ring-1 ring-gray-100">
                            <div className="bg-gray-50 p-8 text-center">
                                ...
                                <div className="mt-1 text-3xl font-black text-[#1f9cd7]">
                                    {rupiah(
                                        Number(transaction.total_harga) || 0,
                                    )}
                                </div>
                            </div>
                                ...
                                {dataMaster ? (
                                    <>
                                        <div className="rounded-2xl bg-blue-50 p-6 text-center">
                                            <p className="text-xs font-bold tracking-widest text-[#1f9cd7] uppercase">
                                                Kirim rincian booking ini ke
                                                admin untuk proses konfirmasi
                                                lebih lanjut.
                                            </p>
                                        </div>
                                        ...
                                        (remainingMs === null ||
                                            ...
                                            <Button
                                                asChild
                                                className="h-14 w-full rounded-2xl bg-emerald-500 text-sm font-black tracking-widest text-white uppercase shadow-lg shadow-emerald-500/30 hover:bg-emerald-600 active:scale-95"
                                            >
                                                <a
                                                    href={contactUrl ?? '#'}
                                                    target="_blank"
                                            ...
                                            <div className="rounded-2xl bg-rose-50 p-4 text-center">
                                                <p className="text-xs font-bold tracking-widest text-rose-600 uppercase">
                                                    {status === 'expired'
